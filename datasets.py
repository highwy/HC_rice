...
DATASETS_CONFIG = {
        ...
        'rice': {
            'urls': ['http://www.ehu.eus/ccwintco/uploads/6/67/rice.mat',
                     'http://www.ehu.eus/ccwintco/uploads/c/c4/rice_gt.mat'],
            'img': 'rice.mat',
            'gt': 'rice_gt.mat'
            },
    }
...
def get_dataset(dataset_name, target_folder="./", datasets=DATASETS_CONFIG):
    ...
    if dataset_name == 'PaviaC':
        ...
        gt = open_file(folder + 'rice_gt.mat')['rice_label']

        label_values = ['backgrand','rice1', 'rice2', 'rice3', 'rice4']
...
class HyperX(torch.utils.data.Dataset):
    ...
    def __init__(self, data, gt, **hyperparams):
        ...
        Args:
            ...
            patch_size: int, size of the spatial neighbourhood 空间邻域的大小
            center_pixel: bool, set to True to consider only the label of the
                          center pixel 仅考虑中心像素
